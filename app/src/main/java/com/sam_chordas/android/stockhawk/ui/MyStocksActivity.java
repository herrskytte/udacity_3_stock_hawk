                ...
                new RecyclerViewItemClickListener.OnItemClickListener() {
                    @Override public void onItemClick(View v, int position) {
                        ...
                        if (mCursor.getInt(mCursor.getColumnIndex(QuoteColumns.HASDATA)) == 1){
                            ...
                            Toast.makeText(MyStocksActivity.this, R.string.stock_nodata_error,
                    ...
                    new MaterialDialog.Builder(mContext).title(R.string.symbol_search)
                            ...
                            .input(R.string.input_hint, R.string.input_prefill, new MaterialDialog.InputCallback() {
                                @Override public void onInput(@NonNull MaterialDialog dialog, CharSequence input) {
                                    ...
                                    String stockName = input.toString().toUpperCase();
                                    ...
                                    if (c == null || c.getCount() != 0) {
                                        Toast.makeText(MyStocksActivity.this, R.string.stock_exists_error,
                                                Toast.LENGTH_LONG).show();

                                    } else {
                                        // Add the stock to DB
                                        mServiceIntent.putExtra("tag", "add");
                                        mServiceIntent.putExtra("symbol", stockName);
                                        startService(mServiceIntent);
                                    }
                                    if(c != null){
                                        c.close();
